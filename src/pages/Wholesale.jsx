    ...
    <div>
      ...
      <div className="bg-gradient-to-br from-primary-700 to-primary-900 text-white py-16 px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <a
            href={`https://wa.me/${WHATSAPP_NUMBER}?text=Hola%2C%20me%20interesa%20ser%20distribuidor%20de%20Aura.%20Quisiera%20m%C3%A1s%20informaci%C3%B3n.`}
            target="_blank" rel="noopener noreferrer"
            className="border-2 border-white/60 text-white font-bold px-7 py-3 rounded-lg hover:bg-white/10 transition-colors inline-flex items-center gap-2">
            ¿Querés distribuir? <ArrowRight size={16} />
          </a>
        </div>
      </div>
